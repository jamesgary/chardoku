...
var _user$project$Common$indexOf = F2(
	function (row, col) {
		return (col + (3 * (row - 1))) - 1;
	});
var _user$project$Common$getCellAt = F3(
	function (row, col, cells) {
		return A2(
			...
			A2(
				...
				A2(_user$project$Common$indexOf, row, col),
				cells));
	});
var _user$project$Common$Model = F3(
	function (a, b, c) {
		return {cells: a, focusIndex: b, status: c};
	});
var _user$project$Common$Invalid = function (a) {
	return {ctor: 'Invalid', _0: a};
};
var _user$project$Common$Valid = {ctor: 'Valid'};
var _user$project$Common$InputCell = F2(
	function (a, b) {
		return {ctor: 'InputCell', _0: a, _1: b};
	});
var _user$project$Common$KeyDownCell = F2(
	function (a, b) {
		return {ctor: 'KeyDownCell', _0: a, _1: b};
	});
var _user$project$Common$ClickCell = function (a) {
	return {ctor: 'ClickCell', _0: a};
};
var _user$project$Common$FocusCell = function (a) {
	return {ctor: 'FocusCell', _0: a};
};

var _user$project$View$viewCell = F3(
	function (focusIndex, index, cell) {
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$maxlength(1),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
										_user$project$Common$ClickCell(index)),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Events$onFocus(
											_user$project$Common$FocusCell(index)),
										_1: {
											ctor: '::',
											_0: A3(
												_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
																									...
																									_1: {
																										...
																										_0: _rtfeldman$elm_css$Css$backgroundImage(
																											A4(
																												...
																												_rtfeldman$elm_css$Css$deg(180),
																												A2(
																													_rtfeldman$elm_css$Css$stop2,
																													_rtfeldman$elm_css$Css$hex('fefbff'),
																													_rtfeldman$elm_css$Css$pct(20)),
																												A2(
																													_rtfeldman$elm_css$Css$stop2,
																													_rtfeldman$elm_css$Css$hex('fce5ff'),
																										...
																										_1: {
																											...
																											_0: A3(
																												...
																												_rtfeldman$elm_css$Css$vw(0.4),
																												_rtfeldman$elm_css$Css$solid,
																												A4(_rtfeldman$elm_css$Css$rgba, 35, 24, 58, 0.99)),
																											_1: {
																												ctor: '::',
																												_0: _rtfeldman$elm_css$Css$width(
																													_rtfeldman$elm_css$Css$vw(8)),
																												_1: {
																													ctor: '::',
																													...
																													_1: {
																														...
																														_0: _rtfeldman$elm_css$Css$margin(
																															_rtfeldman$elm_css$Css$vw(0.2)),
																														_1: {
																															ctor: '::',
																															_0: A2(_rtfeldman$elm_css$Css$property, 'text-size-adjust', 'auto'),
																															_1: {
																																ctor: '::',
																																_0: _rtfeldman$elm_css$Css$focus(
																																	{
																																		...
																																		_0: A3(
																																			...
																																			_rtfeldman$elm_css$Css$vw(0.4),
																																			_rtfeldman$elm_css$Css$solid,
																																			A4(_rtfeldman$elm_css$Css$rgba, 40, 60, 180, 0.99)),
																																		_1: {
																																			ctor: '::',
																																			_0: A5(
																																				...
																																				_rtfeldman$elm_css$Css$zero,
																																				_rtfeldman$elm_css$Css$vw(0.2),
																																				_rtfeldman$elm_css$Css$vw(0.1),
																																				A4(_rtfeldman$elm_css$Css$rgba, 120, 36, 185, 0.7)),
																																			_1: {
																																				ctor: '::',
																																				_0: _rtfeldman$elm_css$Css$backgroundImage(
																																					A4(
																																						...
																																						A2(
																																							_rtfeldman$elm_css$Css$stop2,
																																							_rtfeldman$elm_css$Css$hex('fefbe0'),
																																							_rtfeldman$elm_css$Css$pct(20)),
																																						A2(
																																							_rtfeldman$elm_css$Css$stop2,
																																							_rtfeldman$elm_css$Css$hex('fce5e0'),
																																							_rtfeldman$elm_css$Css$pct(100)),
																																						{ctor: '[]'})),
																																				_1: {ctor: '[]'}
																																			}
...
var _user$project$View$viewRow = F3(
	function (row, focusIndex, cells) {
		return A2(
			...
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A3(
					_user$project$View$viewCell,
					focusIndex,
					A2(_user$project$Common$indexOf, row, 1),
					A3(_user$project$Common$getCellAt, row, 1, cells)),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$View$viewCell,
						focusIndex,
						A2(_user$project$Common$indexOf, row, 2),
						A3(_user$project$Common$getCellAt, row, 2, cells)),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$View$viewCell,
							focusIndex,
							A2(_user$project$Common$indexOf, row, 3),
							A3(_user$project$Common$getCellAt, row, 3, cells)),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$View$viewReason = function (reason) {
	return A2(
			...
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					...
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						A4(_rtfeldman$elm_css$Css$rgba, 183, 50, 42, 0.9)),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: A4(
								_rtfeldman$elm_css$Css$textShadow4,
								_rtfeldman$elm_css$Css$zero,
								_rtfeldman$elm_css$Css$zero,
								_rtfeldman$elm_css$Css$vw(0.2),
								A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.87)),
							_1: {
								ctor: '::',
								_0: A3(
									_rtfeldman$elm_css$Css$padding3,
									_rtfeldman$elm_css$Css$vw(1),
									_rtfeldman$elm_css$Css$vw(2),
									_rtfeldman$elm_css$Css$vw(0.5)),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$fontSize(
										_rtfeldman$elm_css$Css$vw(2)),
									_1: {
										...
										_0: A3(
											_rtfeldman$elm_css$Css$border3,
											_rtfeldman$elm_css$Css$vw(0.3),
											_rtfeldman$elm_css$Css$solid,
											A3(_rtfeldman$elm_css$Css$rgb, 103, 0, 2)),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$borderRadius(
												_rtfeldman$elm_css$Css$vw(1)),
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text(reason),
			_1: {ctor: '[]'}
		});
};
	...
	if (_p1.ctor === 'Valid') {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundColor(
								_rtfeldman$elm_css$Css$hex('00b500')),
							_1: {
								ctor: '::',
								_0: A3(
									_rtfeldman$elm_css$Css$padding3,
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$letterSpacing(
													_rtfeldman$elm_css$Css$vw(5.0e-2)),
												_1: {
													ctor: '::',
													_0: A4(
														_rtfeldman$elm_css$Css$textShadow4,
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('tada'),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('You did it!'),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
			...
			A2(_elm_lang$core$List$map, _user$project$View$viewReason, _p1._0));
	}
};
var _user$project$View$widthThird = _rtfeldman$elm_css$Css$width(
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css_Foreign$global(
				{
					ctor: '::',
					_0: A2(
							...
							_1: {
								...
								_0: _rtfeldman$elm_css$Css$backgroundImage(
									A4(
										...
										A2(
											_rtfeldman$elm_css$Css$stop2,
											_rtfeldman$elm_css$Css$hex('fad0c4'),
											_rtfeldman$elm_css$Css$pct(0)),
										A2(
											_rtfeldman$elm_css$Css$stop2,
											_rtfeldman$elm_css$Css$hex('ffd1ff'),
											_rtfeldman$elm_css$Css$pct(100)),
										{ctor: '[]'})),
								_1: {
									ctor: '::',
				...
				_0: A2(
						...
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$color(
									_rtfeldman$elm_css$Css$hex('170d4c')),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$center),
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$margin2,
											_rtfeldman$elm_css$Css$pct(1),
											_rtfeldman$elm_css$Css$pct(3)),
										_1: {
											ctor: '::',
											_0: _user$project$View$widthThird,
											_1: {ctor: '[]'}
										}
									}
								}
					...
					},
					{
						...
						_0: A2(
								...
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
									{
										...
										_1: {
											ctor: '::',
											_0: A3(
												_rtfeldman$elm_css$Css$textShadow3,
												_rtfeldman$elm_css$Css$vw(0.1),
												_rtfeldman$elm_css$Css$vw(0.2),
												A4(_rtfeldman$elm_css$Css$rgba, 80, 35, 255, 0.5)),
											_1: {
												ctor: '::',
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text('Chardoku'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$href('https://github.com/jamesgary/chardoku'),
									_1: {
										ctor: '::',
											...
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
												{
													...
													_1: {
														...
														_0: A3(
															...
															_rtfeldman$elm_css$Css$vw(0.1),
															_rtfeldman$elm_css$Css$vw(0.2),
															A4(_rtfeldman$elm_css$Css$rgba, 80, 35, 255, 0.2)),
														_1: {
															ctor: '::',
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_0: A4(
																						...
																						_rtfeldman$elm_css$Css$vw(0.1),
																						_rtfeldman$elm_css$Css$zero,
																						A4(_rtfeldman$elm_css$Css$rgba, 193, 136, 185, 0.7)),
																					_1: {
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$hover(
																							{
																								ctor: '::',
																								_0: _rtfeldman$elm_css$Css$color(
																									_rtfeldman$elm_css$Css$hex('a63ce4')),
																								_1: {
																									ctor: '::',
																									_0: A3(
																										_rtfeldman$elm_css$Css$borderBottom3,
																										_rtfeldman$elm_css$Css$vw(0.1),
																										_rtfeldman$elm_css$Css$solid,
																										A4(_rtfeldman$elm_css$Css$rgba, 166, 60, 228, 0.7)),
																									_1: {
																										ctor: '::',
																										_0: A4(
																											_rtfeldman$elm_css$Css$boxShadow4,
							...
							_1: {
										...
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
											{
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$color(
														_rtfeldman$elm_css$Css$hex('352a71')),
													_1: {
														ctor: '::',
														_0: A3(
															_rtfeldman$elm_css$Css$textShadow3,
															_rtfeldman$elm_css$Css$vw(0.1),
															_rtfeldman$elm_css$Css$vw(0.1),
															A4(_rtfeldman$elm_css$Css$rgba, 80, 35, 255, 0.1)),
														_1: {ctor: '[]'}
													}
												}
											}),
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text('Fun fact: There are 85,068 solutions using the '),
											_1: {
												ctor: '::',
												_0: A2(
													_rtfeldman$elm_css$Html_Styled$a,
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled_Attributes$href('http://scrabble.merriam.com/3-letter-words'),
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Html_Styled_Attributes$target('_blank'),
															_1: {ctor: '[]'}
													...
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled$text('Official Scrabble™ Players Dictionary'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A3(_user$project$View$viewRow, 1, model.focusIndex, model.cells),
									_1: {
										ctor: '::',
										_0: A3(_user$project$View$viewRow, 2, model.focusIndex, model.cells),
										_1: {
											ctor: '::',
											_0: A3(_user$project$View$viewRow, 3, model.focusIndex, model.cells),
											_1: {ctor: '[]'}
										}
									}
								}),
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$View$viewStatus(model.status),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Words$words = _elm_lang$core$Set$fromList(
	A2(_elm_lang$core$String$split, '\n', 'aah\naal\naas\naba\nabs\naby\nace\nact\nadd\nado\nads\nadz\naff\naft\naga\nage\nago\nags\naha\nahi\nahs\naid\nail\naim\nain\nair\nais\nait\naji\nala\nalb\nale\nall\nalp\nals\nalt\nama\nami\namp\namu\nana\nand\nane\nani\nant\nany\nape\napo\napp\napt\narb\narc\nare\narf\nark\narm\nars\nart\nash\nask\nasp\nass\nate\natt\nauk\nava\nave\navo\nawa\nawe\nawl\nawn\naxe\naye\nays\nazo\nbaa\nbad\nbag\nbah\nbal\nbam\nban\nbap\nbar\nbas\nbat\nbay\nbed\nbee\nbeg\nbel\nben\nbes\nbet\nbey\nbib\nbid\nbig\nbin\nbio\nbis\nbit\nbiz\nboa\nbob\nbod\nbog\nboo\nbop\nbos\nbot\nbow\nbox\nboy\nbra\nbro\nbrr\nbub\nbud\nbug\nbum\nbun\nbur\nbus\nbut\nbuy\nbye\nbys\ncab\ncad\ncaf\ncam\ncan\ncap\ncar\ncat\ncaw\ncay\ncee\ncel\ncep\nchi\ncig\ncis\ncob\ncod\ncog\ncol\ncon\ncoo\ncop\ncor\ncos\ncot\ncow\ncox\ncoy\ncoz\ncru\ncry\ncub\ncud\ncue\ncum\ncup\ncur\ncut\ncuz\ncwm\ndab\ndad\ndag\ndah\ndak\ndal\ndam\ndan\ndap\ndas\ndaw\nday\ndeb\ndee\ndef\ndel\nden\ndep\ndev\ndew\ndex\ndey\ndib\ndid\ndie\ndif\ndig\ndim\ndin\ndip\ndis\ndit\ndoc\ndoe\ndog\ndoh\ndol\ndom\ndon\ndor\ndos\ndot\ndow\ndry\ndub\ndud\ndue\ndug\nduh\ndui\ndum\ndun\nduo\ndup\ndye\near\neat\neau\nebb\neco\necu\nedh\neds\neek\neel\neew\neff\nefs\neft\negg\nego\neke\neld\nelf\nelk\nell\nelm\nels\neme\nemo\nems\nemu\nend\neng\nens\neon\nera\nere\nerg\nern\nerr\ners\ness\nest\neta\neth\neve\newe\neye\nfab\nfad\nfag\nfah\nfan\nfar\nfas\nfat\nfax\nfay\nfed\nfee\nfeh\nfem\nfen\nfer\nfes\nfet\nfeu\nfew\nfey\nfez\nfib\nfid\nfie\nfig\nfil\nfin\nfir\nfit\nfix\nfiz\n
_user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$clearCellAt = F2(
	function (index, cells) {
		return A3(_elm_lang$core$Array$set, index, _elm_lang$core$Maybe$Nothing, cells);
	});
var _user$project$Main$setCellAt = F3(
	function (index, $char, cells) {
		return A3(
...
var _user$project$Main$nextIndex = function (index) {
	return (_elm_lang$core$Native_Utils.cmp(index + 1, 8) > 0) ? 0 : (index + 1);
};
var _user$project$Main$listCharsToStr = function (chars) {
	return _elm_lang$core$String$concat(
		A2(
			_elm_lang$core$List$map,
			function (c) {
				return A2(_elm_lang$core$String$cons, c, '');
			},
			chars));
};
var _user$project$Main$getCharAt = F2(
	function (index, cells) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Maybe$Just(
...
var _user$project$Main$getWord = F3(
	function (index, dir, cells) {
		var _p0 = dir;
		if (_p0.ctor === 'Right') {
			var chars = {
				ctor: '::',
				_0: A2(_user$project$Main$getCharAt, index * 3, cells),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$getCharAt, (index * 3) + 1, cells),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$getCharAt, (index * 3) + 2, cells),
						_1: {ctor: '[]'}
					}
				}
			};
			return A2(_elm_lang$core$List$member, _elm_lang$core$Maybe$Nothing, chars) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
				_user$project$Main$listCharsToStr(
					A2(
						_elm_lang$core$List$map,
						_elm_lang$core$Maybe$withDefault(
							_elm_lang$core$Native_Utils.chr('&')),
			...
			var chars = {
				ctor: '::',
				_0: A2(_user$project$Main$getCharAt, index, cells),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$getCharAt, index + 3, cells),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$getCharAt, index + 6, cells),
						_1: {ctor: '[]'}
					}
				}
			};
...
var _user$project$Main$checkWord = F4(
	function (index, dir, words, cells) {
		var maybeWord = A3(_user$project$Main$getWord, index, dir, cells);
		var _p1 = maybeWord;
		if (_p1.ctor === 'Just') {
			var _p2 = _p1._0;
			return A2(
				...
				words) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
				A2(
					_elm_lang$core$Basics_ops['++'],
...
var _user$project$Main$select = _elm_lang$core$Native_Platform.outgoingPort(
	'select',
	function (v) {
		return v;
	});
...
var _user$project$Main$validate = function (cells) {
	var checkedWordReasons = A2(
		_elm_lang$core$List$filterMap,
		_elm_lang$core$Basics$identity,
		{
			ctor: '::',
			_0: A4(_user$project$Main$checkWord, 0, _user$project$Main$Right, _user$project$Words$words, cells),
			_1: {
				ctor: '::',
				_0: A4(_user$project$Main$checkWord, 1, _user$project$Main$Right, _user$project$Words$words, cells),
				_1: {
					ctor: '::',
					_0: A4(_user$project$Main$checkWord, 2, _user$project$Main$Right, _user$project$Words$words, cells),
					_1: {
						ctor: '::',
						_0: A4(_user$project$Main$checkWord, 0, _user$project$Main$Down, _user$project$Words$words, cells),
						_1: {
							ctor: '::',
							_0: A4(_user$project$Main$checkWord, 1, _user$project$Main$Down, _user$project$Words$words, cells),
							_1: {
								ctor: '::',
								_0: A4(_user$project$Main$checkWord, 2, _user$project$Main$Down, _user$project$Words$words, cells),
								_1: {ctor: '[]'}
							}
						}
					}
	...
	var filledOutCells = A2(
		_elm_lang$core$List$filterMap,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$Array$toList(cells));
	var isIncomplete = _elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(filledOutCells),
		9) < 0;
	var uniqueCount = _elm_lang$core$Set$size(
		_elm_lang$core$Set$fromList(filledOutCells));
	var hasDuplicateChars = _elm_lang$core$Native_Utils.cmp(
		uniqueCount,
		_elm_lang$core$List$length(filledOutCells)) < 0;
	var reasons = _elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: isIncomplete ? {
				ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: hasDuplicateChars ? {
					ctor: '::',
					_0: 'Duplicate characters!',
					_1: {ctor: '[]'}
				} : {ctor: '[]'},
				_1: {
					ctor: '::',
					_0: checkedWordReasons,
					_1: {ctor: '[]'}
				}
			}
		});
	return _elm_lang$core$List$isEmpty(reasons) ? _user$project$Common$Valid : _user$project$Common$Invalid(reasons);
};
var _user$project$Main$init = function () {
	var cells = A2(_elm_lang$core$Array$repeat, 9, _elm_lang$core$Maybe$Nothing);
	return {
		ctor: '_Tuple2',
		_0: {
			cells: cells,
			focusIndex: _elm_lang$core$Maybe$Just(0),
			status: _user$project$Main$validate(cells)
		},
		_1: _user$project$Main$select('0')
	};
}();
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$MoveToIndex = function (a) {
	return {ctor: 'MoveToIndex', _0: a};
};
var _user$project$Main$keycodeToAction = F2(
	function (keycode, index) {
		var _p3 = A2(_elm_lang$core$Debug$log, 'kc', keycode);
		var _p4 = keycode;
		switch (_p4) {
			case 38:
				return (_elm_lang$core$Native_Utils.cmp(index - 3, 0) < 0) ? _user$project$Main$MoveToIndex(index) : _user$project$Main$MoveToIndex(index - 3);
			case 40:
				return (_elm_lang$core$Native_Utils.cmp(index + 3, 8) > 0) ? _user$project$Main$MoveToIndex(index) : _user$project$Main$MoveToIndex(index + 3);
			case 37:
				return A2(
					_elm_lang$core$List$member,
					index,
					...
					}) ? _user$project$Main$MoveToIndex(index) : _user$project$Main$MoveToIndex(index - 1);
			case 39:
				return A2(
					_elm_lang$core$List$member,
					index,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'FocusCell':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							focusIndex: _elm_lang$core$Maybe$Just(_p5._0)
						}),
					{ctor: '[]'});
			case 'ClickCell':
				var _p6 = _p5._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							focusIndex: _elm_lang$core$Maybe$Just(_p6)
						}),
					{
						ctor: '::',
						_0: _user$project$Main$select(
							_elm_lang$core$Basics$toString(_p6)),
						_1: {ctor: '[]'}
					});
			case 'KeyDownCell':
				var _p7 = A2(_user$project$Main$keycodeToAction, _p5._1, _p5._0);
				if (_p7.ctor === 'MoveToIndex') {
					var _p8 = _p7._0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								focusIndex: _elm_lang$core$Maybe$Just(_p8)
							}),
						{
							ctor: '::',
							_0: _user$project$Main$select(
			...
			default:
				var _p10 = _p5._0;
				var _p9 = _elm_lang$core$String$uncons(_p5._1);
				if (_p9.ctor === 'Just') {
					if (_p9._0._0.valueOf() === ' ') {
						var cells = A2(_user$project$Main$clearCellAt, _p10, model.cells);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								...
								}),
							{
								...
								_0: _user$project$Main$select(
									_elm_lang$core$Basics$toString(
										_user$project$Main$nextIndex(_p10))),
								_1: {ctor: '[]'}
							});
					} else {
						var cells = A3(_user$project$Main$setCellAt, _p10, _p9._0._0, model.cells);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									focusIndex: _elm_lang$core$Maybe$Just(
										_user$project$Main$nextIndex(_p10)),
									cells: cells,
									status: _user$project$Main$validate(cells)
								}),
